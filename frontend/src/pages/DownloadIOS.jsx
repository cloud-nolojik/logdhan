    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-4 py-16 bg-main-gradient">
      ...
      >
        ...
        <p className="text-xl text-white/90 mb-8">
          Get LogDhan on your iPhone or iPad and start making smarter trading decisions
        </p>
        ...
        <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 mb-8">
          ...
          <div className="space-y-4">
            <a
              href="https://apps.apple.com/app/logdhan/id123456789"
              target="_blank"
              rel="noopener noreferrer"
              className="block bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold px-8 py-4 rounded-xl shadow-2xl transition-all duration-300 transform hover:scale-105"
            >
            ...
            <div className="bg-white/5 border border-white/10 text-white/60 font-semibold px-8 py-4 rounded-xl">
              <div className="flex items-center justify-center gap-3">
                <span className="text-2xl">🧪</span>
                <div>
                  <div className="text-lg">TestFlight Beta</div>
        ...
        <div className="bg-white/5 border border-accent-purple/30 rounded-2xl p-6 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-white/80 text-sm">
            ...
            <div>✅ iPhone 7 or newer</div>
            <div>✅ 150MB free storage</div>
            <div>✅ Internet connection</div>
          </div>
        </div>

        <div className="bg-accent-purple/10 border border-accent-purple/30 rounded-2xl p-6 mb-8">
          <h4 className="text-lg font-semibold text-white mb-3">🔒 Privacy & Security</h4>
          <p className="text-white/80 text-sm">
            LogDhan uses Apple's secure frameworks and doesn't store sensitive trading data on our servers. 
