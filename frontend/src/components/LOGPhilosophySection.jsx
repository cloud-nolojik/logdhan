...
const logBlocks = [
  {
    ...
    desc: 'Log your trades systematically',
  ...
  },
  {
    ...
    desc: 'Optimise decisions with AI insights',
  ...
  },
  {
    ...
    desc: 'Generate Dhan through disciplined trading',
...
export default function LOGPhilosophySection() {
  return (
    <section className="py-16 px-4 max-w-4xl mx-auto text-center">
      <h2 className="text-2xl md:text-3xl font-bold text-white mb-8">Our Philosophy: <span className="text-gold-light">The L.O.G. Method</span></h2>
      ...
      <div className="italic text-white/90 text-lg max-w-2xl mx-auto mt-4">
        "LogDhan isn't just an app. It's your AI mentor for mastering money."
      </div>
    </section>
  );
} 