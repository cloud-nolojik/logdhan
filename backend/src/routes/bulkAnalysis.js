...
router.get('/status', auth, async (req, res) => {
    try {
        ...
        console.log(`📊 [STATUS API] Request from user ${userId}, analysis_type: ${analysis_type}`);
        ...
        console.log(`📤 [STATUS API] No active session found - returning default status: target_count=${targetCount}`);
