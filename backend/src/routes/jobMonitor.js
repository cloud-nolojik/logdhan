...
const JOB_REGISTRY = [
  ...
  { key: 'dailyEntry', name: 'daily-picks-entry', description: 'ORB validate + entry + trailing + tighten', schedule: '9:15/9:30/*/3/14:00 Mon-Fri', collection: 'daily_entry_jobs', singleton: dailyEntryJob },
