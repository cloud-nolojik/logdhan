...
const JOB_REGISTRY = [
  ...
  { key: 'dailyPicksScan1', name: 'daily-pick-scan', description: 'Scan + enrich + score picks', schedule: '8:40 AM Mon-Fri', collection: 'daily_picks_jobs', singleton: dailyPicksJob },
