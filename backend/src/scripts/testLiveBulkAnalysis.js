...
async function generateTestReport() {
    ...
    console.log('✓ Market Timing Restrictions');
    console.log('✓ Complete Bulk Analysis Flow');
    console.log('✓ Session Management & Cancellation');
    console.log('✓ Cross-User Cache Sharing');
    console.log('✓ Restart Behavior');
    console.log('✓ Strategies Endpoint');
...
async function runLiveTests() {
    console.log(chalk.bold.blue('🚀 LIVE BULK ANALYSIS FLOW TESTS\n'));
    console.log(`Testing backend at: ${chalk.underline(BASE_URL)}`);
...
console.log('1. Update BASE_URL if your backend runs on different port');
console.log('2. Replace mock JWT tokens with real tokens from your auth system');
console.log('3. Ensure backend is running and accessible');
console.log('4. Install chalk if not available: npm install chalk\n');

console.log(chalk.green('▶️  Run with: node src/scripts/testLiveBulkAnalysis.js\n'));
