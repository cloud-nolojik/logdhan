...
class IntradayValidationTest {
  ...
  async runAllTests() {
    console.log('🧪 Testing NSE Intraday Trading Validations...\n');
  ...
  async testTradingWindowUpdate() {
    console.log('🧪 Test 1: NSE Trading Window (09:15-15:20)...');
  ...
  async testMedianMoveCalculation() {
    console.log('\\n🧪 Test 2: Median 1-minute move calculation...');
  ...
  async testTimeToTargetValidation() {
    console.log('\\n🧪 Test 3: Time-to-target validation logic...');
  ...
  async testMomentumCheck() {
    console.log('\\n🧪 Test 4: 2-hour momentum absence detection...');
  ...
  printResults() {
    console.log('\\n📊 Intraday Validation Test Results:');
    ...
    if (passed === total) {
      console.log('\\n🎉 All intraday validation tests passed! NSE timing and momentum checks are working.');
    } else {
      console.log('\\n⚠️  Some tests failed. Review intraday validation logic.');
