...
const backtestPickSchema = new mongoose.Schema({
  ...
  trade: {
    status: {
      type: String,
      enum: ['PENDING', 'COLLECTING_ORB', 'GAP_FADE_WATCH', 'GAP_FADE_EXPIRED', 'VALIDATED', 'ORDER_PLACED', 'ENTERED', 'TARGET_HIT', 'STOPPED_OUT', 'TIME_EXIT', 'SKIPPED', 'FAILED', 'NO_FILL', 'NO_DATA', 'SPLIT_DETECTED'],
      default: 'PENDING'
    },
    entry_price: Number,
    entry_time: Date,
